...
class LibraryView(ft.Container):
                        ...
                        content=ft.Container(
                            ...
                            content=ft.Column([
                                ft.ListTile(
                                    ...
                                    title=ft.Text(mat['topic_name'], weight="bold"),
                                    subtitle=ft.Text(f"{mat['subject']} • {len(mat['content'].split())} words"),
    ...
    def start_study(self, material):
        # Navigate to study view with material data
        self.page.go(f"/study?id={material['id']}")
    ...
    def on_material_added(self):
        self.load_materials()
        self.load_subjects()
        self.page.snack_bar = ft.SnackBar(ft.Text("Material added successfully!"))
...
class AddMaterialDialog(ft.AlertDialog):
    def __init__(self, page, on_success):
        ...
        self.db = Database()
        self.ai = AIEngine(api_key=page.client_storage.get("google_api_key"))
        ...
        # Make input scrolling on mobile
        ...
        self.content = ft.Container(
            ...
            content=ft.Column([
                self.tabs,
                ft.Container(content=self.manual_content, expand=True, visible=True, key="manual_container"),
                ft.Container(content=self.ai_content, expand=True, visible=False, key="ai_container")
            ])
        )
    ...
    def handle_tab_change(self, e):
        ...
        self.content.content.controls[1].visible = is_manual
        self.content.content.controls[2].visible = not is_manual
        self.page.update()
    ...
    def generate_content(self, e):
        ...
        try:
            ...
            # Switch to manual tab with populated data
